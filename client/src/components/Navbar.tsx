                    ...
                    <>
                        <div className='flex justify-between items-center w-full text-sm text-gray-500'>
                            ...
                            <div className='flex items-center space-x-6'>
                                ...
                                <div>
                                    <a href='#'><img src="/profile.jpg" alt="Profile" className='h-8 w-8 rounded-full border border-gray-300 hover:cursor-pointer' /></a>
                                </div>
                                <a href='#' className='flex items-center space-x-1 cursor-pointer hover:text-red-600'>
                                    <FaPowerOff/>
                                    <span>ИЗХОД</span>
                                </a>
                            </div>
